...
if not on_rtd:
    html_context = {
        ...
        "github_repo": "sky90fd-pdk",   # Repo name
...
html_logo = "_static/sky90fd-pdk-logo-top.png"
...
html_theme_options = {
    ...
    'github_url': 'https://github.com/google/sky90fd-pdk',
    'repo_name': 'sky90fd-pdk',
    'repo_type': 'github',
...
htmlhelp_basename = 'sky90fd-pdk-doc'
...
latex_documents = [
    (
        ...
        'sky90fd-pdk.tex',
        # title
        'SkyWater SKY90FD PDK Documentation',
        # author
        author,
        # document class
        'manual',
...
man_pages = [
    ('sky90fd-pdk', 'SkyWater 90nm FDSOI PDK Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        # dir menu entry
        'SkyWater SKY90FD PDK',
        # description
        'Documentation for open source PDK targetting SkyWater SKY90FD process node.',
        # category
        'Miscellaneous',
    ),
]
